"""This module contains classes for RFdiffusion inference."""
...
class Sampler:
    ...
    def initialize(self, conf: BaseConfig) -> None:
        """Initialize sampler.
    ...
    @property
    def T(self):
        """Return the maximum number of timesteps that this design protocol will perform.
    ...
    def construct_denoiser(self, L, visible):
        ...
        denoise_kwargs: dict = OmegaConf.to_container(self.diffuser_conf)
    ...
    def __init__(self, conf: DictConfig):
        ...
        if conf.scaffoldguided.scaffold_dir is None:
            ...
            if conf.contigmap.inpaint_str_loop is not None:
                if not conf.scaffoldguided.mask_loops:
                    raise ValueError(
